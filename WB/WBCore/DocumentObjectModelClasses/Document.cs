...
namespace WBCore.DocumentObjectModelClasses
{
    public class Document : INode
    {
        ...
        public DocumentObjectModel DocumentObjectModel { get; set; } = new DocumentObjectModel();
        IEnumerable<Tag> GetTags()
        {
            Element currentTag = DocumentObjectModel.Root.Children.ElementAtOrDefault(0);
        ...
        public Document(string html, DocumentObjectModel dom)
        {
            Html = html;
        ...
        public override string ToString()
        {
            ...
            foreach (Element element in DocumentObjectModel.Root.Children)
            {

...
namespace WBCore
{
	internal class Parser
	{
        ...
        int ParseStartTag(int i)
        {
			...
			List<DocumentObjectModelClasses.TagAttribute> attributes = new List<DocumentObjectModelClasses.TagAttribute>();
            ...
            while (k < endPos)
            {
                ...
                attributes.Add(new DocumentObjectModelClasses.TagAttribute(attributeName, attributeValue));
                k = k + match.Length;
            }

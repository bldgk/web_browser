...
namespace SavageCore.SourceCodeModeling.Handlers
{
	internal class Parser
	{
        ...
        int ParseStartTag(int i)
        {
			...
			List<SavageCore.SourceCodeModeling.Structure.TagAttribute> attributes = new List<SavageCore.SourceCodeModeling.Structure.TagAttribute>();
            ...
            while (k < endPos)
            {
                ...
                attributes.Add(new SavageCore.SourceCodeModeling.Structure.TagAttribute(attributeName, attributeValue));
                k = k + match.Length;
            }

            Tag tag = Tag.Create("WBCore.DocumentObjectModelClasses.HtmlTags." + lastTag, attributes) as Tag;

...
namespace HtmlAgilityPack
{
  ...
  public class HtmlEntity
  {
                  ...
                  if ((int) stringBuilder2[0] == 35)
                  {
                    ...
                    try
                    {
                      ...
                      if (str2.StartsWith("x"))
                      {
                        ...
                        fromBase = 10;
                      int num = Convert.ToInt32(str2, fromBase);
    ...
    /// 
    /// </summary>
    /// <param name="text">The source text.</param><param name="useNames">If set to false, the function will not use known entities name. Default is true.</param>
    /// <returns>
    /// The result text.
    /// </returns>
    ...
    /// 
    /// </summary>
    /// <param name="text">The source text.</param><param name="useNames">If set to false, the function will not use known entities name. Default is true.</param><param name="entitizeQuotAmpAndLtGt">If set to true, the [quote], [ampersand], [lower than] and [greather than] characters will be entitized.</param>
    /// <returns>
    /// The result text
    /// </returns>

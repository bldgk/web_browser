...
namespace HtmlAgilityPack
{
  ...
  public class HtmlWeb
  {
    ...
    /// 
    /// </summary>
    /// <param name="htmlUrl">The requested URL, such as "http://Myserver/Mypath/Myfile.asp".</param><param name="xsltUrl">The URL that specifies the XSLT stylesheet to load.</param><param name="xsltArgs">An <see cref="T:System.Xml.Xsl.XsltArgumentList"/> containing the namespace-qualified arguments used as input to the transform.</param><param name="type">The requested type.</param>
    /// <returns>
    ...
    /// 
    /// </summary>
    /// <param name="htmlUrl">The requested URL, such as "http://Myserver/Mypath/Myfile.asp".</param><param name="xsltUrl">The URL that specifies the XSLT stylesheet to load.</param><param name="xsltArgs">An <see cref="T:System.Xml.Xsl.XsltArgumentList"/> containing the namespace-qualified arguments used as input to the transform.</param><param name="type">The requested type.</param><param name="xmlPath">A file path where the temporary XML before transformation will be saved. Mostly used for debugging purposes.</param>
    /// <returns>
    /// An newly created instance.
    /// </returns>
    public object CreateInstance(string htmlUrl, string xsltUrl, XsltArgumentList xsltArgs, Type type, string xmlPath)
    {
      ...
      {
        throw new Exception((string) (object) ex + (object) ", --- xml:" + (string) (object) stringWriter);
      }
    }
    ...
    /// 
    /// </summary>
    /// <param name="htmlUrl">The requested URL, such as "http://Myserver/Mypath/Myfile.asp". May not be null.</param><param name="xsltUrl">The URL that specifies the XSLT stylesheet to load.</param><param name="xsltArgs">An XsltArgumentList containing the namespace-qualified arguments used as input to the transform.</param><param name="writer">The XmlTextWriter to which you want to save.</param><param name="xmlPath">A file path where the temporary XML before transformation will be saved. Mostly used for debugging purposes.</param>
    public void LoadHtmlAsXml(string htmlUrl, string xsltUrl, XsltArgumentList xsltArgs, XmlTextWriter writer, string xmlPath)
    {
      ...
      xsltArgs.AddParam("fromCache", "", (object)Convert.ToBoolean((this.FromCache ? 1 : 0)));
    ...
    /// 
    /// </summary>
    /// <param name="url">The requested URL, such as "http://Myserver/Mypath/Myfile.asp".</param><param name="type">The requested type.</param>
    /// <returns>
    /// An newly created instance.
    /// </returns>
    ...
    /// 
    /// </summary>
    /// <param name="url">The requested URL, such as "http://Myserver/Mypath/Myfile.asp".</param><param name="path">The location of the file where you want to save the document.</param>
    ...
    /// 
    /// </summary>
    /// <param name="url">The requested URL, such as "http://Myserver/Mypath/Myfile.asp".</param><param name="path">The location of the file where you want to save the document.</param><param name="proxy"/><param name="credentials"/>
    ...
    /// 
    /// </summary>
    /// <param name="url">The requested URL, such as "http://Myserver/Mypath/Myfile.asp".</param><param name="path">The location of the file where you want to save the document.</param><param name="method">The HTTP method used to open the connection, such as GET, POST, PUT, or PROPFIND.</param>
    ...
    /// 
    /// </summary>
    /// <param name="url">The requested URL, such as "http://Myserver/Mypath/Myfile.asp".</param><param name="path">The location of the file where you want to save the document.</param><param name="credentials"/><param name="method">The HTTP method used to open the connection, such as GET, POST, PUT, or PROPFIND.</param><param name="proxy"/>
    ...
    /// 
    /// </summary>
    /// <param name="url">The requested URL, such as "http://Myserver/Mypath/Myfile.asp".</param><param name="proxyHost">Host to use for Proxy</param><param name="proxyPort">Port the Proxy is on</param><param name="userId">User Id for Authentication</param><param name="password">Password for Authentication</param>
    /// <returns>
    /// A new HTML document.
    /// </returns>
    ...
    /// 
    /// </summary>
    /// <param name="url">The requested URL, such as "http://Myserver/Mypath/Myfile.asp".</param><param name="method">The HTTP method used to open the connection, such as GET, POST, PUT, or PROPFIND.</param>
    /// <returns>
    /// A new HTML document.
    /// </returns>
    ...
    /// 
    /// </summary>
    /// <param name="htmlUrl">The requested URL, such as "http://Myserver/Mypath/Myfile.asp".</param><param name="writer">The XmlTextWriter to which you want to save to.</param>
    ...
    private HttpStatusCode Get(Uri uri, string method, string path, HtmlDocument doc, IWebProxy proxy, ICredentials creds)
    {
      ...
      if (this.PostResponse != null)
        this.PostResponse(request, httpWebResponse);
      this._requestDuration = Environment.TickCount - tickCount;
      this._responseUri = httpWebResponse.ResponseUri;
      bool flag2 = this.IsHtmlContent(httpWebResponse.ContentType);
      Encoding encoding = !string.IsNullOrEmpty(httpWebResponse.ContentEncoding) ? Encoding.GetEncoding(httpWebResponse.ContentEncoding) : (Encoding) null;
      if (this.OverrideEncoding != null)
      ...
      if (responseStream != null)
      {
        if (this.UsingCache)
        {
          HtmlWeb.SaveStream(responseStream, str, HtmlWeb.RemoveMilliseconds(httpWebResponse.LastModified), this._streamBufferSize);
          this.SaveCacheHeaders(request.RequestUri, httpWebResponse);
          if (path != null)
          {
            IOLibrary.CopyAlways(str, path);
            System.IO.File.SetLastWriteTime(path, System.IO.File.GetLastWriteTime(str));
    ...
    private void SaveCacheHeaders(Uri requestUri, HttpWebResponse resp)
    {
      ...
      foreach (string index in (NameObjectCollectionBase) resp.Headers)
      {
        XmlNode newChild = (XmlNode) xmlDocument.CreateElement("h");
        XmlAttribute attribute1 = xmlDocument.CreateAttribute("n");
        attribute1.Value = index;
        newChild.Attributes.Append(attribute1);
        XmlAttribute attribute2 = xmlDocument.CreateAttribute("v");
        attribute2.Value = resp.Headers[index];
